...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.positionRedux !== this.props.positionRedux) {
            let arrPostions = this.props.positionRedux;
            this.setState({
                positionArr: arrPostions,
                position: arrPostions && arrPostions.length > 0 ? arrPostions[0].keyMap : ''
    ...
    checkValidateInput = () => {
        ...
        for (let i = 0; i < arrCheck.length; i++) {
            if (!this.state[arrCheck[i]]) {
                isValid = false;
                alert('This input is repuired: ' + arrCheck[i])
                break;
            }
        }
        return isValid;
    ...
    render() {
        ...
        // console.log('check position: ', positions)
        let {
                ...
                <div className='box'>
                    ...
                    <div className="user-redux-body">
                        <div className="container">
                            <div className="row">
                                <div className="col-12 my-3 title-box">Administrative Rights</div>
                                <div className="col-12">{isGetGenders == true ? '...loading api: genders, position, role...' : ''}</div>
