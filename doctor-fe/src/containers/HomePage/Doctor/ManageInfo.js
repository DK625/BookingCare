...
class ManageInfo extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.allDoctors !== this.props.allDoctors) {
            ...
            const filteredData = dataSelect.filter(item => item.value === id);
            console.log('check 55: ', filteredData);
            console.log('check infor: ', this.props.userInfo.user.id);
            this.setState({
                listDoctors: filteredData
                ...
                <div className='manage-doctor-container'>
                    <div className='box'>
                        ...
                        <div className="more-infor-extra row">
                            ...
                            <div className="col-4 form-group">
                                <label> <FormattedMessage id="admin.manage-doctor.province" />
                                </label>
                                <Select
                            ...
                            <div className="col-4 form-group">
                                ...
                                <input className="form-control input-height" placeholder='Tên phòng khám'
                            ...
                            <div className="col-4 form-group">
                                ...
                                <input className="form-control input-height" placeholder='Địa chỉ phòng khám'
                            ...
                            <div className="col-4 form-group">
                                ...
                                <input className="form-control input-height" placeholder='Ghi chú'
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageInfo);